...
/*   Updated: 2024/10/15 01:54:04 by ide-dieg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void 	ft_init_sprites(t_game *game)
{
	...
	game->sprites[4] = ft_new_sprite(game, "sprites/key.xpm");
	game->sprites[5] = ft_new_sprite(game, "sprites/cofre_cerrado.xpm");
	i = 0;
	while (i < 6)
	{
		if (!game->sprites[i])
